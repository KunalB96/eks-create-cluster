...
## 🔑 Create Access Key for User `kunal`

1. In **IAM Users**, click on `kunal`.
...
```
// on powershell (choose which every in free trial)
```
...
| Task                       | Command / Action                                                                                      |
| :------------------------- | :---------------------------------------------------------------------------------------------------- |
| Create IAM User            | AWS Console → IAM → Users → Add User `kunal`                                                           |
| Create Access Key          | AWS Console → IAM → Users → `kunal` → Security credentials                                             |
